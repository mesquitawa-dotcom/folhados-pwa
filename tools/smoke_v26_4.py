...
try:
    cmd=[chrome,'--headless=new','--no-sandbox','--disable-gpu','--disable-background-networking','--virtual-time-budget=5000','--dump-dom','http://127.0.0.1:8765/_smoke_v26_4.html']
    ...
    print('SMOKE v26.4 OK · boot offline autorizado chegou à tela inicial')
finally:
    server.shutdown()
