...
for(const m of ["atualização v26.7","const POS_PRODUTOS=","fdo_partidas","fdo_formas","function salvarCorteLaminacao()","function posFreezerRapido","function posFreezerConservador","function posIniciarDescongelamento","function posModelagemDireta","function montarForma","function abrirEtiquetaPartida","FB.criarFormaAtomica","versao:'26.7'"])assert(html.includes(m),'marcador ausente: '+m);
...
const sw=fs.readFileSync('sw.js','utf8');assert(sw.includes("const CACHE='fdo-v26-7'"));
